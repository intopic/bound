...
9. Provo edhe **SOL → USDC** (0.01 SOL) dhe një memecoin, p.sh. **USDC → BONK** (2 USDC). Nëse nuk ke pasur kurrë BONK, faqja shfaq rreshtin **New BONK account 0.00148844 SOL** (shuma vjen nga Solana). Kjo është depozita që Solana mban në llogarinë tënde të re dhe mbetet e jotja.
