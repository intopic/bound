...
import { SOLANA_ERROR__JSON_RPC__SERVER_ERROR_MIN_CONTEXT_SLOT_NOT_REACHED, TRANSACTION_CONFIG_COMPUTE_UNIT_LIMIT_BIT_MASK, TRANSACTION_CONFIG_LOADED_ACCOUNTS_DATA_SIZE_LIMIT_BIT_MASK, TRANSACTION_CONFIG_PRIORITY_FEE_LAMPORTS_BIT_MASK, address, decompileTransactionMessage, fetchAddressesForLookupTables, getAddressDecoder, getAddressEncoder, getCompiledTransactionMessageDecoder, getProgramDerivedAddress, getTransactionDecoder, getTransactionMessageComputeUnitLimit, getTransactionMessageLoadedAccountsDataSizeLimit, getTransactionMessagePriorityFeeLamports, getTransactionSize, isOffCurveAddress, isSignerRole, isSolanaError, isWritableRole } from "@solana/kit";
...
*/
const ORIENTIM_TREASURY = "ARzSA3sZGhf5t4UnYrmB3TWyZ5m3Wo1nA9zWBcoiTqLE";
const BIGINT_FIELDS = [
	"minOut",
	"takerRent",
	"routeRefund",
...
//#endregion
export { ORIENTIM_TREASURY, STATUS_CACHE_BLOCKS, inputTransferFee, ownMinimum, ownSolFeeLimit, pastProof, provesNeverLanded, verifyPrepared };
