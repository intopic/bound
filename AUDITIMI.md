...
| D13 | Përjashtohen DEX-et që marrin qira të përhershme shumë të lartë nga taker-i (HumidiFi) | Me një E të re për çdo swap, ajo qira (~0.013 SOL) do të humbte çdo herë. Qiraja e Pump.fun-it (~0.0013–0.0015 SOL, PumpSwap dhe bonding curve) paguhet me `takerRent` dhe i tregohet klientit (AUDIT.md 0k) |
| D14 | ATA(E, m) të ndërmjetme i krijon Bound dhe i mbyll te W | Disa route (p.sh. Quay) kalojnë fillimisht përmes ATA(E, output) |
| D15 | Një route i mbrojtur më shumë se 0.5% (1% deri më 23 shtator 2026) nën atë pa kufizime i tregohet klientit dhe vendos ai (`costs-more`), me paralajmërim më të fortë mbi 5%; Bound refuzon vetë vetëm mbi 50%, ku përgjigjja nuk është më çmim. Nuk bllokojmë një tregti thjesht se nuk na pëlqen. Simulimet e dështuara nisin riparimin e route-it | Jupiter një herë ktheu `outAmount = 0` dhe një herë një route 12% më të keq, prandaj një hendek i madh trajtohet si përgjigje e prishur. Një hendek i vogël është çmimi i mbrojtjes, dhe atë e vendos klienti, jo ne |
